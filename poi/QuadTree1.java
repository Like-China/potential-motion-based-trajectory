...
public class QuadTree1 {
    ...
    private QuadTree1[] children; // Subdivided quadrants

    public QuadTree1(double x1, double y1, double x2, double y2) {
        this.x1 = x1;
        this.y1 = y1;
        this.x2 = x2;
        this.y2 = y2;
    ...
    private void subdivide() {
        ...
        children[0] = new QuadTree1(x1, y1, midX, midY); // Top-left
        children[1] = new QuadTree1(midX, y1, x2, midY); // Top-right
        children[2] = new QuadTree1(x1, midY, midX, y2); // Bottom-left
        children[3] = new QuadTree1(midX, midY, x2, y2); // Bottom-right
    }

    public static void main(String[] args) {
        QuadTree1 tree = new QuadTree1(0, 0, 100, 100);
